            ...
            <table class="table table-hover">
                ...
                <c:forEach var="dish" items="${dishes}">
                    <tr class="d-flex">
                        ...
                        <td class="col-sm-2">
                            <button class="btn click-btn button round-button" href="/user/basket?id=${dish.id_dish}"><i class="ti-minus"></i>
                            </button>
                        </td>
                    </tr>
                </c:forEach>
            ...
            <table class="table table-hover">
                ...
                <c:forEach var="drink" items="${drinks}">
                    <tr class="d-flex">
                        ...
                        <td class="col-sm-2">
                            <button class="btn click-btn button round-button" href="/user/basket?id=${drink.id_dish}"><i class="ti-minus"></i>
                            </button>
                        </td>
                    </tr>
                </c:forEach>
