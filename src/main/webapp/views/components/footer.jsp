<!-- ================ start footer Area ================= -->
<footer class="footer-area section-gap" style="background-color: #E9967A; color: white">
    <div class="container">
        <div class="row">
            <div class="col-xl-8 col-sm-6 mb-6 mb-xl-0 single-footer-widget">
                <h4>Contacts</h4>

                <img src="${pageContext.request.contextPath}/static/img/2Restoran1.png" alt=""/>
                <p>Phone number: 00 (440) 9865 562<br/>Mon to Fri 9am to 6pm<br/></p>
                <p>Address: West 29th Street, New York. <br/>Rosemead, CA 91770<br/></p>
