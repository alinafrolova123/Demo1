        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container box_1620">
                <button type="button" class="btn red-button sidebarCollapse">
                    ...
                    <span><i class="ti-menu"/></span>
                </button>
                <a class="navbar-brand logo" href="${pageContext.request.contextPath}/views/admin/index_admin.jsp"><img src="/static/img/2Restoran1.png" alt=""/></a>

                <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                    <ul class="nav navbar-nav menu_nav justify-content-end">
                        <li class="nav-item active"><a class="nav-link" href="${pageContext.request.contextPath}/views/admin/index_admin.jsp">Home</a></li>
                        <li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/views/admin/about_admin.jsp">About</a></li>
                        <li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/views/admin/menu_admin.jsp">Menu</a></li>
                        <li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/views/admin/contact_admin.jsp">Contact</a></li>
                        <li class="nav-item"><a class=" button button-shadow mt-2 mt-lg-4" href="${pageContext.request.contextPath}/views/user/login.jsp">Log out</a>
                        </li>
                    </ul>
                </div>
            </div>
